...
const uni = graduates.filter( grads => (grads.university.indexOf("Uni") != -1)).map( grads => grads.university);
console.log(uni);
...
zooAnimals.forEach(za => {
    animalNames.push(`${za.scientific_name} ${za.animal_name}`)
});
...
*/
const lowerPopulation = zooAnimals.filter(function(arrayitem){
